                              ...
                              <?php
                                 ...
                                 ?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select multiple id="default_category" name="newsomatic_rules_list[default_category][]" class="cr_width_full" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
                                                ...
                                                <td>
                                                   <div class="hideFull">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo sprintf( wp_kses( __( "Select the query type you want to search for the article full content. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'newsomatic-news-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url_raw( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                               ?>
                                                         </div>
                                                      </div>
       ...
       foreach ( get_post_types( '', 'names' ) as $post_type ) {
          ...
          $output .= '>' . esc_html($post_type) . '</option>';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select multiple class="cr_width_full" id="default_category" name="newsomatic_rules_list[default_category' . esc_html($cont) . '][]" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
               ...
               $output .= '/>
                           ...
                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Shortcode for this rule<br/>(to cross-post from this plugin in other plugins):', 'newsomatic-news-post-generator'), array(  'br' => array( ) ) ) ) . '<br/><b>%%newsomatic_0_' . esc_html($cont) . '%% and %%newsomatic_title_0_' . esc_html($cont) . '%%</b><br/>' . esc_html__('Posts Generated:', 'newsomatic-news-post-generator') . ' ' . esc_html($generated_posts) . '<br/>';
               ...
               if (!empty($running)) {           
                   if (!in_array(array($cont => '0'), $running)) {
                        ...
                        if($f !== false)
                        {
                            ...
                            $wp_filesystem->delete(get_temp_dir() . 'newsomatic_0_' . $cont);
                        }
                        $output .= ' cr_hidden';
                   }
                   else
